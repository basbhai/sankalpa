          ...
          <div className="text-center">
            ...
            <div className="mb-6">
              <p className="text-gray-700">
                ...
                efficient and appropriate for the protection of interests of our
                clients and attainment of their goals.
              </p>
            </div>
            <div className="mb-6">
              <div className="flex items-center">
                ...
                <div className="text-lg font-medium">
                  We believe, with the correct team and strategy, justice can't
                  be denied.
                </div>
              </div>
            </div>
